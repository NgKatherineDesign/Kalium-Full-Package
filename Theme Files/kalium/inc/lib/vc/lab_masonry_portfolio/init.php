...
// Element Information
$lab_vc_element_icon = kalium()->locateFileUrl( 'inc/lib/vc/lab_masonry_portfolio/masonry.svg' );
...
vc_map( array(
	...
	'admin_enqueue_js' => kalium()->locateFileUrl( 'inc/lib/vc/lab_masonry_portfolio/init-lab-masonry.js' ),
	"params"           => array(
		array(
			'type'        => 'dropdown',
			'heading'     => 'Box Size',
