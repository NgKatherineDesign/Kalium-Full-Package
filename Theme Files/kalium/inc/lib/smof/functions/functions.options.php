...
$of_options[] = array( 	'desc' 		=> "Set maximum width for the uploaded logo, mostly used when you use retina (@2x) logo<br /><small>{$note_str} Even if you don't upload custom logo, you may set custom width for the current logo in sticky menu.</small>",
	...
	*/
		...
		$of_options[] = array(
			...
			'id'   => 'portfolio_lb',
			'std'  => "
						<h3 style=\"margin: 0 0 10px;\">We have moved Custom JavaScript to Other Settings section</h3>
						<p>
							<a href=\"#\" class='smof-go-to-new-custom-js-tab'>Click here to go to Custom JavaScript tab &raquo;</a>
						</p>",
			'icon' => true,
			'type' => 'info',
...
// Portfolio Loop
		...
		$filter_terms_by_category = array();
