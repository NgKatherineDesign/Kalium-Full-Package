...
<form id="typolab-settings-form" method="post" enctype="application/x-www-form-urlencoded">
    ...
    <div id="typolab-advanced-settings"<?php echo kalium()->url->get( 'typolab-advanced-settings', true ) ? ' class="visible"' : ''; ?>>
			...
			<tr class="hover vtop">
				<td>
					<div class="description">
						...
						<small>If you don't know how to make directory writable, <a href="https://www.dummies.com/web-design-development/wordpress/navigation-customization/how-to-change-file-permissions-using-filezilla-on-your-ftp-site/" target="_blank">click here</a> to learn more.</small>
						<div class="error">
