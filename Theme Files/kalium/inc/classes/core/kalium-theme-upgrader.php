...
class Kalium_Theme_Upgrader {
	...
	public function after_setup_theme() {
		...
		add_action( 'upgrader_process_complete', array( $this, 'afterThemeUpdateFilter' ), 100, 2 );
	...
	public function displayThemeUpdateNotices() {
		...
		if ( current_user_can( 'update_themes' ) && in_array( $pagenow, array( 'update-core.php', 'themes.php' ) ) ) {
			...
			wp_enqueue_script( 'kalium-theme-update-notice', kalium()->assetsUrl( 'js/admin/theme-update-notice.min.js' ), null, kalium()->getVersion() );
