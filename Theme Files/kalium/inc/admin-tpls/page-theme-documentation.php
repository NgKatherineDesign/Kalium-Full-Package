...
$faq_articles = array(
	...
	array(
		...
		'content' => 'Every time when there is new update for WoCommerce, make sure that Kalium is compatible with that version <em>(in our <a href="https://1.envato.market/KYm9a" target="_blank">item page</a>)</em> before updating to latest version of WooCommerce.
