...
$custom_prevnext_links      = kalium()->acf->get_field( 'custom_prevnext_links' );

if ( $custom_prevnext_links ) {
	$prev = apply_filters( 'kalium_portfolio_custom_prev_link', kalium()->acf->get_field( 'prevnext_previous_id' ) );
	$next = apply_filters( 'kalium_portfolio_custom_prev_link', kalium()->acf->get_field( 'prevnext_next_id' ) );
} else {
